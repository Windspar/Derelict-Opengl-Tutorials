...
void main()
{
    if(!setupScreen("Tri Color Triangle", 800, 600))
        return;
    ...
    vao.attribute(0, 3, GL_FLOAT, GL_FALSE, 6 * GLfloat.sizeof, cast(void*)0);
    vao.attribute(1, 3, GL_FLOAT, GL_FALSE, 6 * GLfloat.sizeof, cast(void*)(3 * GLfloat.sizeof));
    vao.unbind();
